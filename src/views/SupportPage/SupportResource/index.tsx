    ...
    <Card>
      <CardHeader>
        ...
        <ActionGroup className="ml-auto">
          ...
          <Button startIcon={<StartIcon src={PlusCircle} alt="pluscircle" />} scale={scales.SM}>
            Get Support
          </Button>
        </ActionGroup>
      </CardHeader>
      <CardBody>
        <SupportForumsContainer>
          ...
          <TypographyText>Search the topic you need help with in our support forums.</TypographyText>
          <Link path="#"><TypographySmall>BROWSE FORUMS</TypographySmall> <img src={RightArrow} alt="rightarrow" />
          </Link>
          <SearchContainer>
            <Input
